...
class PagesController extends PanelController {
    ...
    public function indexAction(){
        ...
        $content = '<div class="fx">
            ...
            <a href="/'.CONFIG_SYSTEM["panel"].'/pages/add/" class="btn">Добавить</a>
        </div>';
        ...
        if($Pages["pages"]){
            ...
            foreach ($Pages["pages"] as $row) {
                ...
                $pageContent .= '<tr>
                    ...
                    <td>
                        <a href="//'.CONFIG_SYSTEM["home"].'/'.CONFIG_SYSTEM["panel"].'/pages/edit/'.$row["id"].'/">'.$row["title"].'</a>
                    </td>
        ...
        $this->view->render('Статические страницы', $content);
    }
