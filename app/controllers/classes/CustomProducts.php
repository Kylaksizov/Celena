    ...
    public function get($e, $paginationPow = false, $categories = [], $template = 'customProducts', $limit = 10, $order = 'id', $sort = 'desc'){
        ...
        if(!empty($Products["products"])){
            ...
            if($e->route["controller"] == 'plugins\Celena\Shop\Category'){ // если категория
                ...
                $e->view->setMeta($Products["categories"][$Products["products"][0]["category_id"]]["m_title"], $Products["categories"][$Products["products"][0]["category_id"]]["m_description"], [
                    [
                        'property' => 'og:title',
                        'content' => $Products["categories"][$Products["products"][0]["category_id"]]["m_title"],
                    ],
                    [
                        'property' => 'og:description',
                        'content' => $Products["categories"][$Products["products"][0]["category_id"]]["m_description"],
                    ]
                ]);
            }
